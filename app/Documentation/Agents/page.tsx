...
export default function DocumentationPage() {
  return (
    <div className="w-full lg:w-3/4 p-6 space-y-16 text-gray-200">
      {/* Welcome Section */}
      ...
      <section id="register" className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-6">
          <li>
            ...
            <div className="mt-3 border border-gray-700 rounded-md p-4 bg-gray-900 text-sm w-max">
              <Image
                src="/admin-registration.svg"
                alt="Admin creating a user account"
                width={600}
                height={400}
              />
              <p className="mt-2 text-gray-400 text-xs">
                Screenshot: Admin user creation interface
              </p>
            </div>
          </li>
          ...
          <li>
            ...
            <div className="mt-3 border border-gray-700 rounded-md p-4 bg-gray-900 text-sm w-max">
              <Image
                src="/self-registration.svg"
                alt="Self registration on login screen"
                width={600}
                height={400}
              />
              <p className="mt-2 text-gray-400 text-xs">
      ...
      <section id="login" className="space-y-4">
        ...
        <div className="border border-gray-700 rounded-md p-4 bg-gray-900 text-sm">
          <p className="text-gray-400 text-xs">
            Screenshot: Dashboard view after successful login
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="border border-gray-700 rounded-md p-4 bg-gray-900 text-sm">
          <p className="text-gray-400 text-xs">
            Screenshot: Penalty percentage setup form
          </p>
        </div>
